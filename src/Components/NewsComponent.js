    ...
    <>
      <div className="main-container">
        <div className="news-container">
          <div className="effect">Welcome to the News 27</div>
            ...
            <div className="col-4">
              <div className="row">
                <ul className="right-heading-ul">
                  <li className="right-heading para">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Voluptatum, ratione Lorem ipsum dolor sit amet..
                  </li>
                  <li className="right-heading para">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Voluptatum, ratione.
                  ...
                  <li className="right-heading para para">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Voluptatum, ratione.
                  </li>
                  <li className="right-heading para">
                  ...
                  <li className="right-heading para">
                    ...
                    amet consectetur adipisicing elit. Voluptatum, ratione.
                  </li>
                  <li className="right-heading para">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Voluptatum, ratione.
            ...
            <div className="col-3 sec-right-heading ">
              ...
              <ul className="sec-right-heading-ul">
                <li className="sec-right-heading">
                  ...
                  <p className="para">
                    Lorem ipsum dolor sit ametr Lorem ipsum dolor sit amet
                    consectetur..
                  </p>
                </li>
            ...
            <div className="col-9 mt-4">
                  ...
                  <div className="row row-cols-3">
                    ...
                    <div className="col-4">
                      ...
                      <div className="navigate-content">
                        <span className="entity">&larr;</span>{" "}
                        <span className="small-rect1"></span>
                        <span className="small-rect2"></span>{" "}
                        <span className="entity">&rarr;</span>
                      </div>
                    </div>
                    <div className="col-4">
                      <img src={image1} alt="IMG" className="image3" />
              ...
              <div className="row cricket-row">
                <div className="cricket-logos">
                  <img
                    className="cricket-news27-logo"
                    src={News27logo}
                    alt=""
                  />
                  <img
                    className="cricket-next-logo"
                    src={CricketNextSvg}
                    alt=""
                  />
                  <img
                    className="cricket-silhouette-logo"
                    src={CricketSilhouette}
                    alt=""
                  />
                ...
                <div className="col-10">
                  <div className="row cricket-second-column">
                    ...
                    <div className="col-6 cricket-sec-row">
                      <img
                        src={image1}
                        alt="IMG"
                        className="grid-item-image1-second-row"
                      />
                      <p className="para">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Mollitia saepe laboriosam
                    ...
                    <div className="col-6 col-6 cricket-sec-row">
                      <img
                        src={image1}
                        alt="IMG"
                        className="grid-item-image1-second-row"
                  ...
                  <div className="card" style={{ width: "8rem" }}>
                    <div className="card-body">
                      <h6 className="card-title">
                        <i className="fa fa-location-arrow"></i> Mumbai
                      </h6>
